...
public class FileOperation {
    ...
    public static HashMap<String, ZipEntry> unZipAPk(String fileName, String filePath) throws IOException {
        checkDirectory(filePath);
        ZipFile zipFile = new ZipFile(fileName);
        Enumeration emu = zipFile.entries();
        HashMap<String, ZipEntry> compress = new HashMap<>();
        try {
            while (emu.hasMoreElements()) {
                ...
                // 获取压缩方法
                compress.put(compatibaleresult, entry);
    ...
    public static void zipFiles(
            ...
            File zipFile,
            // 压缩模式
            Map<String, Integer> compressData)
            throws IOException {
    ...
    private static void zipFile(
            ...
            String rootpath,
            Map<String, Integer> compressData) throws IOException {
